var game_methods = {
	...
	changeProductPrice: function(price, product){
		var self =this;
	...
	changeRegionPref: function(number, region){
		...
		if(region){
			...
			self.news.push({
				...
				type: "newspaper-o", /////Types: usd, newspaper-o, user, warning
				header: "Region Conservatism Change",
				text: "Preference in \""+region+"\" has been changed by "+number+".",
			});
			...
			self.news.push({
				...
				type: "newspaper-o", /////Types: usd, newspaper-o, user, warning
				header: "Global People Number Change",
				text: "Global Preferences have been changed by "+number+".",
			});
		}
	},
